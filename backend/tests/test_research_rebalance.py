...
def test_endpoint_reads_account_history_and_returns_no_execution(db_session):
    ...
    run = InvestmentResearchRun(
        ...
        reverse_valuation={},
        # S1/S4：增仓门禁读的是**冻结的结构化决策卡**；没有卡片的记录不允许生成新增订单
        thesis_card={
            "symbol": "000333",
            "name": "测试公司",
            "strategy_type": "quality_value",
            "strategy_label": "长期质量价值",
            "horizon": "3 年以上",
            "return_source": "企业盈利增长与估值修复",
            "as_of": "报告期 2026-06-30",
            "thesis": "",
            "variant_view": "",
            "supporting_evidence_ids": ["calc:dcf_基准"],
            "opposing_evidence_ids": [],
            "assumptions": {},
            "valuation_method": {"available": True, "applicable": True},
            "scenario_result_ids": ["calc:dcf_基准"],
            "invalidation_conditions": ["净资产收益率跌破 3.0% → 论点失效"],
            "review_triggers": ["下一期定期报告发布后"],
            "missing_data": [],
            "decision": "research_candidate",
            "decision_label": "研究候选（非买入建议）",
            "confidence_basis": {"quality_score": 59.9},
