...
- 东方财富数据中心（龙虎榜与席位、大宗交易、融资融券、沪深港通、机构调研、股东户数、限售解禁、业绩预告、分红送配）
...
5. 「市场行情」页可查看东方财富板块行情、板块/个股资金流，以及龙虎榜、大宗交易、
   融资融券、沪深港通、机构调研、股东户数、限售解禁、业绩预告、分红送配等数据中心
   数据集；龙虎榜可下钻到买卖席位。数据源不可用时页面会明确提示，而不是显示空表。
...
回归基线：后端 660 项测试全绿、前端类型检查与生产构建零错误、managed E2E 19/19。
